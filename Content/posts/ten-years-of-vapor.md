...
description: This week marks 10 years of Vapor! We're running a special Vapor Week to celebrate with exclusive merch, look backs and special announcements.
tags: vapor, 10 years
author: 0xTim
---
# Ten Years of Vapor
...
To celebrate our 10 year anniversary, we're running a special Vapor Week! We'll be posting a series of blog posts this week, showcasing the users of Vapor, some history, a look at our new websites and maybe even some special announcements. Tomorrow's post lands on the anniversary and is not one to miss.
...
Vapor is completely open source and funded thanks to the companies and individuals who sponsor it. So if you've sponsored a one-time donation, bought a t-shirt, spoken about Vapor on a podcast or conference, written a blog post, or sponsored through [Open Collective](https://opencollective.com/vapor) or [GitHub Sponsors](https://github.com/sponsors/vapor), for a month or those that have been sponsoring for years, thank you! Your support is what keeps the project going.

If Vapor is useful to you or your company, there are a few ways to keep it going: sponsor the project, pick up [a good first issue](https://github.com/vapor/vapor/issues?q=state%3Aopen%20label%3A%22good%20first%20issue%22), improve the docs, or answer a question in [Discord](https://vapor.team/). All of it counts.